...
data class MediaType(
    ...
    fun mergeEncoding(encodingToMerge: Map<String, Encoding?>?): MediaType {
        return if (encodingToMerge == null) {
            ...
            if (oldEncoding == null) {
                ...
                // hint:70A3D8B6
                setEncoding(de.lancom.openapi.tools.mergeMap(oldEncoding, encodingToMerge))
            }
        }
    }
    ...
    companion object : Parser<MediaType> {
        ...
        // hint:2C0E94A7
        fun parseWrapperWithExtensions(wrapper: Wrapper, extensions: Field<Map<String, Extension?>>): MediaType {
            return MediaType(
