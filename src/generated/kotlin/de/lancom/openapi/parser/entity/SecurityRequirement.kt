...
data class SecurityRequirement(
    ...
    // hint:F0C48D71
    fun setJsonNodeField(jsonNode: Field<JsonNode>): SecurityRequirement {
        return copy(_jsonNode = jsonNode)
            .updateFields()
    }

    // hint:8E56A4D9
    fun updateJsonNodeField(updater: (Field<JsonNode>) -> Field<JsonNode>): SecurityRequirement {
    ...
    // hint:6542E98A
    fun mergeJsonNodeField(jsonNodeFieldToMerge: Field<JsonNode>): SecurityRequirement {
    ...
    // hint:EFD0D818
    fun updateFields(): SecurityRequirement {
    ...
    // hint:D6150566
    fun mergeFields(other: SecurityRequirement): SecurityRequirement {
        return copy(
    ...
    companion object : JsonEntityFactory<SecurityRequirement> {
        ...
        class Serializer : EntitySerializer<SecurityRequirement>(SecurityRequirement::class.java, SecurityRequirement)
        class Deserializer : EntityDeserializer<SecurityRequirement>(SecurityRequirement::class.java, SecurityRequirement)
