...
data class Info(
    ...
    fun getFields(): Set<Fields> {
        val allFields: Set<Fields> = setOfNotNull(
            setOfNotNull<Fields>(
                ...
                if (_termsOfService.isDefined) Fields.termsOfService else null,
                if (_contact.isDefined) Fields.contact else null,
                if (_license.isDefined) Fields.license else null,
                if (_version.isDefined) Fields.version else null,
            ),
    ...
    // hint:D6150566
    fun mergeFields(other: Info): Info {
        return copy(
    ...
    companion object : Parser<Info> {
        ...
        data class Fields(val value: String) {
            ...
            companion object {
                ...
                val termsOfService = Fields("termsOfService")
                val contact = Fields("contact")
                val license = Fields("license")
