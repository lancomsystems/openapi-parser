...
data class RawExtension(
    ...
    // hint:F0C48D71
    fun setJsonNodeField(jsonNode: Field<JsonNode>): RawExtension {
        return copy(_jsonNode = jsonNode)
            .updateFields()
    }

    // hint:8E56A4D9
    fun updateJsonNodeField(updater: (Field<JsonNode>) -> Field<JsonNode>): RawExtension {
    ...
    // hint:6542E98A
    fun mergeJsonNodeField(jsonNodeFieldToMerge: Field<JsonNode>): RawExtension {
    ...
    // hint:D6150566
    fun mergeFields(other: RawExtension): RawExtension {
        return copy(
    ...
    companion object : JsonEntityFactory<Extension> {
        ...
        class Serializer : EntitySerializer<Extension>(Extension::class.java, RawExtension)
        class Deserializer : EntityDeserializer<Extension>(Extension::class.java, RawExtension)
